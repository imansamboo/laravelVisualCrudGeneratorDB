...
Route::resource('ghasams', 'GhasamsController');
Route::resource('reports', 'ReportsController');
Route::resource('reports', 'ReportsController');
Route::resource('reports', 'ReportsController');
Route::resource('reports', 'ReportsController');
Route::resource('reports', 'ReportsController');
Route::resource('reports', 'ReportsController');
Route::resource('wwwwwws', 'WwwwwwsController');
...
Route::resource('fars', 'FarsController');
Route::resource('maradonas', 'MaradonasController');
Route::resource('hcws', 'HcwsController');
Route::resource('ncws', 'NcwsController');
Route::resource('ocws', 'OcwsController');
Route::resource('products', 'ProductsController');
Route::resource('maps', 'MapsController');
Route::resource('maps', 'MapsController');
Route::resource('mapps', 'MappsController');
Route::resource('bombs', 'BombsController');
Route::resource('bods', 'BodsController');
Route::resource('bodds', 'BoddsController');
Route::resource('bbbbbbbbbbbbbs', 'BbbbbbbbbbbbbsController');
Route::resource('hgtjgjgs', 'HgtjgjgsController');
Route::resource('bgcghggcbns', 'BgcghggcbnsController');
Route::resource('sdssdsss', 'SdssdsssController');
Route::resource('admin', 'AdminController');
Route::resource('jomes', 'JomesController');
Route::resource('jomes', 'JomesController');
Route::resource('jomess', 'JomessController');
Route::resource('adminasass', 'AdminasassController');
Route::resource('davaidbababis', 'DavaidbababisController');